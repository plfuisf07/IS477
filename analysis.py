...
fig, ax = plt.subplots(figsize=(15, 10))
ax.plot(df_low["CVE Count"],df_low["CVE Count"]*low_model._results.params[1]+low_model._results.params[0], label="Low", marker="s")
ax.scatter(df_low["CVE Count"], df_low["Total All R&D Expenditures"], label="Low", marker="s")
ax.set_xlabel("CVE Count")
ax.set_ylabel("Total All R&D Expenditures")
ax.set_title("R&D Expenditures vs. CVE Count for Low Severity")
ax.legend()
plt.savefig("low_severity_analysis.png")

fig, ax = plt.subplots(figsize=(15, 10))
ax.plot(df_medium["CVE Count"],df_medium["CVE Count"]*medium_model._results.params[1]+medium_model._results.params[0], label="Medium", marker="^")
ax.scatter(df_medium["CVE Count"], df_medium["Total All R&D Expenditures"], label="Medium", marker="^")
ax.set_xlabel("CVE Count")
ax.set_ylabel("Total All R&D Expenditures")
ax.set_title("R&D Expenditures vs. CVE Count for Medium Severity")
ax.legend()
plt.savefig("medium_severity_analysis.png")

fig, ax = plt.subplots(figsize=(15, 10))
ax.plot(df_high["CVE Count"],df_high["CVE Count"]*high_model._results.params[1]+high_model._results.params[0], label="High", marker="o")
ax.scatter(df_high["CVE Count"], df_high["Total All R&D Expenditures"], label="High", marker="o")
ax.set_xlabel("CVE Count")
ax.set_ylabel("Total All R&D Expenditures")
ax.set_title("R&D Expenditures vs. CVE Count for High Severity")
ax.legend()
plt.savefig("high_severity_analysis.png")

fig, ax = plt.subplots(figsize=(15, 10))
ax.plot(df_critical["CVE Count"],df_critical["CVE Count"]*critical_model._results.params[1]+critical_model._results.params[0], label="Critical", marker="d")
ax.scatter(df_critical["CVE Count"], df_critical["Total All R&D Expenditures"], label="Critical", marker="d")
ax.set_xlabel("CVE Count")
ax.set_ylabel("Total All R&D Expenditures")
ax.set_title("R&D Expenditures vs. CVE Count for Critical Severity")
ax.legend()
plt.savefig("critical_severity_analysis.png")